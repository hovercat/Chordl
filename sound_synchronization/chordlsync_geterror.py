...
parser.add_argument('--resample-div', type=int, help="Influences the accuracy. The original sample rate is divided by this value for error detection; default: 10", default=100)


args = parser.parse_args(["-i", "unittests/resources/enjoy2/fluebee_raw.flac", "-s", "unittests/resources/enjoy/Master.ogg", "--clip-duration", "120", "--resample-div", "100"])
